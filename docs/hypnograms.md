...
Hypnograms summarize sleep stages across time. If valid staging
annotations are present, a hypnogram appears both in the main signal
view and in the hypnogram dock. Stages must map to `N1`, `N2`, `N3`,
`R`, `W`, and `?`; if other labels are used, they can be `remap`ped
via a [parameter file](parameters.md).

![Detailed Hypnogram](imgs/n/hypno-dock-hypno.png)

This tab also reports simple summary statistics such as stage
durations and WASO. Lights out/on times can be adjusted before
recalculating the output with _Run HYPNO_.

![Hypnogram](imgs/n/hypno-dock-run.png)
...
![SOAP Visualization](imgs/n/hypno-dock-soap.png)
...
![POPS Hypnogram](imgs/n/hypno-dock-pops1.png)
...
![POPS Hypnodensity](imgs/n/hypno-dock-pops2.png)
...
![POPS Metrics](imgs/n/hypno-dock-pops3.png)
...
Previous: [Spectrograms](spectrograms.md) | Next: [Masks](masks.md)
